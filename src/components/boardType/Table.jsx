                                    ...
                                    <div>
                                      <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-RootTaskContextMenuTarget">
                                        <div>
                                          <div
                                            role="row"
                                            className="SpreadsheetRow SpreadsheetRow--enabled SpreadsheetRow--withRightGutter DraggableSpreadsheetTaskRow SpreadsheetTaskRow SpreadsheetTaskRow--withoutShadedBackground ProjectSpreadsheetGridRow-assigneeAndDueDateHover"
                                          >
                                            <div
                                              className="SpreadsheetRow-stickyCell"
                                              style={{
                                            ...
                                            >
                                              ...
                                              <div
                                                role="gridcell"
                                                aria-label="asdasdas"
                                                className="SpreadsheetCell--withoutLeftBorder SpreadsheetCell SpreadsheetGridTaskNameAndDetailsCellGroup SpreadsheetTaskRow-nameOrDetailsCell"
                                                tabIndex={-1}
                                                aria-describedby="lui_107"
                                              >
                                                <div
                                                  className="DragHandle DraggableSpreadsheetTaskRow-dragHandle"
                                                  draggable="true"
                                                ...
                                                <label className="SpreadsheetTaskName SpreadsheetTaskName--editable SpreadsheetGridTaskNameAndDetailsCellGroup-taskName">
                                                  ...
                                                  <textarea
                                                    id="Pot.1205343526438001_1205358966417419_1205359926801974"
                                                    className="SpreadsheetTaskName-input override-focus-border override-hover-border"
                                                    placeholder=""
                                                    rows={1}
                                                    tabIndex={0}
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                className="SpreadsheetCell SpreadsheetAssigneeCell-cell SpreadsheetTaskRow-assigneeCell"
                                                tabIndex={-1}
                                                style={{ width: 120 }}
                                              >
                                                <div
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                className="SpreadsheetCell SpreadsheetMutableDateCell-cell SpreadsheetTaskDueDateCell-cell SpreadsheetTaskRow-dueDateCell"
                                                tabIndex={-1}
                                                style={{ width: 120 }}
                                              >
                                                <div
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                aria-label="Priority field for asdasdas"
                                                className="SpreadsheetCell SpreadsheetCustomPropertyEnumCell-spreadsheetCell"
                                                tabIndex={-1}
                                                title=""
                                                style={{ width: 120 }}
                                              >
                                                <div
                                                  id="SpreadsheetCustomPropertyEnumCell-1205359926801974-1205343526438006"
                                                  className="CustomPropertyEnumValueInput-button--large CustomPropertyEnumValueInput-button--grid CustomPropertyEnumValueInput-button CustomPropertyEnumValueInput--empty CustomPropertyEnumValueInput--editable CustomPropertyEnumValueInput--insideCell CustomPropertyEnumValueInput SpreadsheetCustomPropertyEnumCell-field"
                                                  tabIndex={-1}
                                                  aria-expanded="false"
                                                  aria-haspopup="true"
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                aria-label="Status field for asdasdas"
                                                className="SpreadsheetCell SpreadsheetCustomPropertyEnumCell-spreadsheetCell"
                                                tabIndex={-1}
                                                title=""
                                                style={{ width: 120 }}
                                              >
                                                <div
                                                  id="SpreadsheetCustomPropertyEnumCell-1205359926801974-1205343530602587"
                                                  className="CustomPropertyEnumValueInput-button--large CustomPropertyEnumValueInput-button--grid CustomPropertyEnumValueInput-button CustomPropertyEnumValueInput--empty CustomPropertyEnumValueInput--editable CustomPropertyEnumValueInput--insideCell CustomPropertyEnumValueInput SpreadsheetCustomPropertyEnumCell-field"
                                                  tabIndex={-1}
                                                  aria-expanded="false"
                                                  aria-haspopup="true"
                                            ...
                                            <div
                                              className="SpreadsheetPlaceholderCell SpreadsheetTaskRow-addFieldPlaceholder"
                                              style={{ width: 50 }}
                                            />
                                            <div
                                              className="SpreadsheetTaskRow-endOfRowTabStop"
                                        ...
                                        <div>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <div
                                                role="gridcell"
                                                aria-label="sdaasdasdasd"
                                                className="SpreadsheetCell--withoutLeftBorder SpreadsheetCell SpreadsheetGridTaskNameAndDetailsCellGroup SpreadsheetTaskRow-nameOrDetailsCell"
                                                tabIndex={0}
                                                aria-describedby="lui_122"
                                              >
                                                <div
                                                  className="DragHandle DraggableSpreadsheetTaskRow-dragHandle"
                                                  draggable="true"
                                                ...
                                                <label className="SpreadsheetTaskName SpreadsheetTaskName--editable SpreadsheetGridTaskNameAndDetailsCellGroup-taskName">
                                                  ...
                                                  <textarea
                                                    id="Pot.1205343526438001_1205343530602620_1205343530602592"
                                                    className="SpreadsheetTaskName-input override-focus-border override-hover-border"
                                                    placeholder=""
                                                    rows={1}
                                                    tabIndex={0}
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              ...
                                              >
                                                <div
                                                  className="SpreadsheetAssigneeCell-assignee--isAlwaysVisible SpreadsheetAssigneeCell-assignee"
                                                  tabIndex={0}
                                                >
                                                  <div
                                                    className="AssigneeWithNameDisplayButton SpreadsheetAssigneeCell-assigneeDisplay"
                                                  ...
                                                  >
                                                    <div
                                                      className="AssigneeWithNameDisplayButton-avatar"
                                                      role="presentation"
                                                    >
                                                      <div
                                                    ...
                                                    <span className="Typography Typography--overflowTruncate Typography--s AssigneeWithNameDisplayButton-name">
                                                      Ayush
                                                    </span>
                                                  </div>
                                                </div>
                                                <div className="SpreadsheetAssigneeCell-removeButtonWrapper">
                                                  <div
                                                    aria-label="Remove"
                                                  ...
                                                  >
                                                    <svg
                                                      className="MiniIcon SpreadsheetAssigneeCell-xMiniIcon XMiniIcon"
                                                      viewBox="0 0 24 24"
                                                      aria-hidden="true"
                                                      focusable="false"
                                                    >
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              ...
                                              >
                                                <div
                                                  className="SpreadsheetMutableDateCell--isAlwaysVisible SpreadsheetMutableDateCell"
                                                  tabIndex={0}
                                                >
                                                  <div className="SpreadsheetMutableDateCell-dueDateDisplay">
                                                    <div className="DueDateWithRecurrence--xsmall DueDateWithRecurrence DueDateWithRecurrence--soon SpreadsheetMutableDateCell-dueDateWithRecurrence">
                                                      <div className="DueDate--canWrap DueDate DueDateWithRecurrence-dueDate DueDate--soon">
                                                ...
                                                <div className="SpreadsheetMutableDateCell-removeButtonWrapper">
                                                  <div
                                                    aria-label="Remove"
                                                    className="ThemeableIconButtonPresentation--isEnabled ThemeableIconButtonPresentation ThemeableIconButtonPresentation--small SubtleMiniIconButton--standardTheme SubtleMiniIconButton"
                                                    role="button"
                                                  ...
                                                  >
                                                    <svg
                                                      className="MiniIcon SpreadsheetMutableDateCell-xMiniIcon XMiniIcon"
                                                      viewBox="0 0 24 24"
                                                      aria-hidden="true"
                                                      focusable="false"
                                                    >
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                aria-label="Priority field for sdaasdasdasd"
                                                className="SpreadsheetCell SpreadsheetCustomPropertyEnumCell-spreadsheetCell"
                                                tabIndex={-1}
                                                title="Low"
                                                style={{ width: 120 }}
                                              >
                                                <div
                                                  id="SpreadsheetCustomPropertyEnumCell-1205343530602592-1205343526438006"
                                                  className="CustomPropertyEnumValueInput-button--large CustomPropertyEnumValueInput-button--grid CustomPropertyEnumValueInput-button CustomPropertyEnumValueInput--editable CustomPropertyEnumValueInput--insideCell CustomPropertyEnumValueInput SpreadsheetCustomPropertyEnumCell-field"
                                                  tabIndex={-1}
                                                  aria-expanded="false"
                                                  aria-haspopup="true"
                                                  aria-disabled="false"
                                            ...
                                            <div className="ContextMenuTarget-contextMenuEventListener SpreadsheetTaskRow-FieldCellTaskContextMenuTarget">
                                              <div
                                                role="gridcell"
                                                aria-label="Status field for sdaasdasdasd"
                                                className="SpreadsheetCell SpreadsheetCustomPropertyEnumCell-spreadsheetCell"
                                                tabIndex={-1}
                                                title="On track"
                                                style={{ width: 120 }}
                                              >
                                                <div
                                                  id="SpreadsheetCustomPropertyEnumCell-1205343530602592-1205343530602587"
                                                  className="CustomPropertyEnumValueInput-button--large CustomPropertyEnumValueInput-button--grid CustomPropertyEnumValueInput-button CustomPropertyEnumValueInput--editable CustomPropertyEnumValueInput--insideCell CustomPropertyEnumValueInput SpreadsheetCustomPropertyEnumCell-field"
                                                  tabIndex={-1}
                                                  aria-expanded="false"
                                                  aria-haspopup="true"
